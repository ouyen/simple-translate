...
function translatePage(info, tab) {
  ...
  const translationUrl = `https://translate.google.cn/translate?hl=${targetLang}&tl=${targetLang}&sl=auto&u=${encodedPageUrl}`;
...
function translateLink(info, tab) {
  ...
  const translationUrl = `https://translate.google.cn/translate?hl=${targetLang}&tl=${targetLang}&sl=auto&u=${encodedLinkUrl}`;
